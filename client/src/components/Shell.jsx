import { Bot, CheckSquare, Home, Moon, NotebookText, Sun, UserRound } from "lucide-react";
    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_15%_10%,#bfdbfe,transparent_26%),radial-gradient(circle_at_85%_0%,#e9d5ff,transparent_28%),linear-gradient(135deg,#f8fbff,#f7f3ff)] pb-24 text-slate-900 transition-colors dark:bg-[radial-gradient(circle_at_15%_10%,rgba(37,99,235,.34),transparent_28%),radial-gradient(circle_at_90%_0%,rgba(147,51,234,.28),transparent_28%),linear-gradient(135deg,#070b18,#111827)] dark:text-slate-100">
      <header className="sticky top-0 z-20 border-b border-white/70 bg-white/78 backdrop-blur-xl transition-colors dark:border-white/10 dark:bg-slate-950/72">
        <div className="mx-auto flex max-w-6xl items-center gap-4 px-4 py-3">
          ...
          <div className="ml-auto hidden flex-1 max-w-md items-center rounded-xl bg-slate-100 px-4 py-2 text-sm text-slate-500 ring-1 ring-transparent transition-colors sm:flex dark:bg-slate-900 dark:text-slate-400 dark:ring-white/10">
            Search subjects, topics, notes...
          </div>
          <button
            onClick={toggleTheme}
            className="grid h-10 w-10 place-items-center rounded-xl bg-white text-slate-700 shadow-sm ring-1 ring-slate-200 transition hover:-translate-y-0.5 dark:bg-slate-900 dark:text-slate-200 dark:ring-white/10"
      ...
      <footer className="fixed bottom-3 left-1/2 z-30 w-[min(94vw,620px)] -translate-x-1/2 rounded-2xl border border-white/80 bg-white/90 p-2 shadow-soft backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/88">
